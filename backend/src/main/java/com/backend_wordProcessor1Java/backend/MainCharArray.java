...
public class MainCharArray {
        ...
        public MainCharArray(
                ...
                Byte appliedBolding, Byte appliedItalic, Byte appliedUnderline,
                String appliedTextColor, String appliedHighlightColor, String appliedTypeface,
                Integer leftward_ilili, Integer rightward_ilili, Short lineIndex,
                Byte charWidthPxDefault, Byte charHeightPx)
        {
