...
public class TextController {
    ...
    public static HttpStatus insertChar(@PathVariable("userIndex") Byte userIndex, @PathVariable("insertedChar") String insertedChar, @PathVariable("positionOfInsertion") Integer positionOfInsertion, @PathVariable("charWidthPx") Byte charWidthPx, @PathVariable("charHeightPx") Byte charHeightPx) {
        try {
    ...
    public static HttpStatus deleteChar(@PathVariable("userIndex") Byte userIndex, @PathVariable("positionOfDeletedChar") Integer positionOfDeletedChar) {
        try {
    ...
    public static HttpStatus undo_aModification(@PathVariable("userIndex") Byte userIndex) {
        try {
    ...
    public static HttpStatus redo_anUndoneModification(@PathVariable("userIndex") Byte userIndex) {
        try {
    ...
    public static HttpStatus clearCopiedCharStack(@PathVariable("userIndex") Byte userIndex) {
        try {
    ...
    public static HttpStatus addToCopiedCharStack(@PathVariable("userIndex") Byte userIndex, @PathVariable("positionOfCopiedChar") Integer positionOfCopiedChar) {
        try {
    ...
    public static HttpStatus reStyleSelectedChar_bold(@PathVariable("positionOfSelectedChar") Integer positionOfSelectedChar, @PathVariable("appliedBolding") Byte appliedBolding) {
        try {
    ...
    public static HttpStatus reStyleSelectedChar_italic(@PathVariable("positionOfSelectedChar") Integer positionOfSelectedChar, @PathVariable("appliedItalic") Byte appliedItalic) {
        try {
    ...
    public static HttpStatus reStyleSelectedChar_underline(@PathVariable("positionOfSelectedChar") Integer positionOfSelectedChar, @PathVariable("appliedUnderline") Byte appliedUnderline) {
        try {
    ...
    public static HttpStatus reStyleSelectedChar_typeface(@PathVariable("positionOfSelectedChar") Integer positionOfSelectedChar, @PathVariable("appliedTypeface") String appliedTypeface, @PathVariable("charWidthPxDefault") Byte charWidthPxDefault) {
        try {
    ...
    public static HttpStatus reStyleSelectedChar_heightInPx(@PathVariable("positionOfSelectedChar") Integer positionOfSelectedChar, @PathVariable("appliedCharHeightPx") Byte charHeightPx) {
        try {
    ...
    public static HttpStatus reColorSelectedChar_text(@PathVariable("positionOfSelectedChar") Integer positionOfSelectedChar, @PathVariable("appliedTextColor") String appliedTextColor) {
        try {
    ...
    public static HttpStatus reColorSelectedChar_highlight(@PathVariable("positionOfSelectedChar") Integer positionOfSelectedChar, @PathVariable("appliedHighlightColor") String appliedHighlightColor) {
        try {
    ...
    public static ResponseEntity<String> getCharacterInFocus(@PathVariable("mainCharArrayIndex") Integer mainCharArrayIndex) {
        try {
    ...
    public static ResponseEntity<Integer> getLeftward_ilili(@PathVariable("mainCharArrayIndex") Integer mainCharArrayIndex) {
        try {
    ...
    public static ResponseEntity<Integer> getRightward_ilili(@PathVariable("mainCharArrayIndex") Integer mainCharArrayIndex) {
        try {
    ...
    public static ResponseEntity<Integer> getLineIndex(@PathVariable("mainCharArrayIndex") Integer mainCharArrayIndex) {
        try {
    ...
    public static ResponseEntity<Integer> getCharWidthPxDefault(@PathVariable("mainCharArrayIndex") Integer mainCharArrayIndex) {
        try {
    ...
    public static ResponseEntity<Integer> getAppliedBolding(@PathVariable("mainCharArrayIndex") Integer mainCharArrayIndex) {
        try {
    ...
    public static ResponseEntity<Integer> getAppliedItalic(@PathVariable("mainCharArrayIndex") Integer mainCharArrayIndex) {
        try {
    ...
    public static ResponseEntity<Integer> getAppliedUnderline(@PathVariable("mainCharArrayIndex") Integer mainCharArrayIndex) {
        try {
    ...
    public static ResponseEntity<String> getAppliedTypeface(@PathVariable("mainCharArrayIndex") Integer mainCharArrayIndex) {
        try {
    ...
    public static ResponseEntity<String> getAppliedTextColor(@PathVariable("mainCharArrayIndex") Integer mainCharArrayIndex) {
        try {
    ...
    public static ResponseEntity<String> getAppliedHighlightColor(@PathVariable("mainCharArrayIndex") Integer mainCharArrayIndex) {
        try {
